        ...
        <article>
          ...
          <section className="mt-6 grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-8">
            <article className="bg-white group relative rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform duration-200">
              ...
              <div className="px-3 py-4">
                ...
                <h3 className="text-sm text-gray-500 pb-2">
                  <a className="bg-yellow-600 py-1 px-2 text-white rounded-lg" href="/course/1">
            ...
            <article className="bg-white group relative rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform duration-200">
              ...
              <div className="px-3 py-4">
                <h3 className="text-sm text-gray-500 pb-2">
                  <a className="bg-green-600 py-1 px-2 text-white rounded-lg" href="/course/2">
                    <span className="absolute inset-0"></span>
                    Categoria 1
                  </a>
                </h3>
            ...
            <article className="bg-white group relative rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform duration-200">
              ...
              <div className="px-3 py-4">
                <h3 className="text-sm text-gray-500 pb-2">
                  <a className="bg-red-600 py-1 px-2 text-white rounded-lg" href="/course/3">
                    <span className="absolute inset-0"></span>
                    Categoria 3
                  </a>
                </h3>
            ...
            <article className="bg-white group relative rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform duration-200">
              ...
              <div className="px-3 py-4">
                <h3 className="text-sm text-gray-500 pb-2">
                  <a className="bg-blue-600 py-1 px-2 text-white rounded-lg" href="/course/4">
                    <span className="absolute inset-0"></span>
                    Categoria 2
                  </a>
                </h3>
